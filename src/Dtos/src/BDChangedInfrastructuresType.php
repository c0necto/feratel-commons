...
/**
 * Class representing BDChangedInfrastructuresType
 *
 *
 * XSD Type: BDChangedInfrastructuresType
 */
class BDChangedInfrastructuresType
{
    /**
     * @var mixed $details
     */
