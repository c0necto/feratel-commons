...
/**
 * Class representing STUServiceProvidersType
 *
 *
 * XSD Type: STUServiceProviders
 */
class STUServiceProvidersType
{
    /**
     * @var \Conecto\FeratelDsi\Dtos\STUServiceProviderType[] $serviceProvider
     */
     ...
     */
    public function addToServiceProvider(\Conecto\FeratelDsi\Dtos\STUServiceProviderType $serviceProvider)
    {
        $this->serviceProvider[] = $serviceProvider;
        return $this;
    }
