...
namespace Conecto\FeratelDsi\Dtos\PackageCalculationAssignmentItemType\PriceAType;
...
{
    /**
     * @var \Conecto\FeratelDsi\Dtos\PackageCalculationAssignmentItemType\PriceAType\ChildrenAType\PriceChildAType[] $priceChild
     */
    private $priceChild = [
     ...
     */
    public function addToPriceChild(\Conecto\FeratelDsi\Dtos\PackageCalculationAssignmentItemType\PriceAType\ChildrenAType\PriceChildAType $priceChild)
    {
        $this->priceChild[] = $priceChild;
        return $this;
    }
