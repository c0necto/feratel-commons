...
class BookingDetailType
{
    ...
    public function __construct(int $weight = null, int $unitNumber = null, \Conecto\FeratelDsi\Dtos\BookingPriceDetailsType $priceDetails = null, string $paymentType = null, string $mealType = null, string $productName = null, string $serviceName = null, string $serviceId = null, string $serviceProviderName = null, string $serviceProviderId = null, string $childrenAges = null, int $childrenNumber = null, int $adultNumber = null, \DateTime $timeTo = null, int $groupNumber = null, \DateTime $timeFrom = null, \DateTime $dateTo = null, \DateTime $dateFrom = null, int $order = null, string $type = null, string $productId = null, \Conecto\FeratelDsi\Dtos\BookingDetailType\PriceAType $price = null, \Conecto\FeratelDsi\Dtos\BookingDetailType\VatAmountAType $vatAmount = null, string $externalTransactionDetails = null, \Conecto\FeratelDsi\Dtos\BookingPaymentDetailsType $paymentDetails = null, array $cancellationDetails = null)
    {
        $this->weight = $weight;
