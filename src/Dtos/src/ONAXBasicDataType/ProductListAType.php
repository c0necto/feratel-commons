...
/**
 * Class representing ProductListAType
 */
class ProductListAType
{
    /**
     * @var \Conecto\FeratelDsi\Dtos\ONAXProductItemType[] $product
     */
    private $product = [
     ...
     */
    public function addToProduct(\Conecto\FeratelDsi\Dtos\ONAXProductItemType $product)
    {
        $this->product[] = $product;
        return $this;
    }
