...
/**
 * Class representing AddToShoppingCartType
 *
 *
 * XSD Type: AddToShoppingCartType
 */
class AddToShoppingCartType
{
    /**
     * @var string $id
     */
    ...
    public function __construct(string $id = null, string $dbCode = null, string $salesChannelId = null, \Conecto\FeratelDsi\Dtos\CartItemAccommodationType $cartItemAccommodation = null, \Conecto\FeratelDsi\Dtos\CartItemBrochureType $cartItemBrochure = null, \Conecto\FeratelDsi\Dtos\CartItemAdditionalServiceType $cartItemAdditionalService = null, \Conecto\FeratelDsi\Dtos\CartItemPackageType $cartItemPackage = null, \Conecto\FeratelDsi\Dtos\CartItemShopArticleType $cartItemShopArticle = null)
    {
        $this->id = $id;
        $this->dbCode = $dbCode;
