...
class BDServiceProviderDetailsType
{
    ...
    public function __construct(string $name = null, int $rooms = null, \Conecto\FeratelDsi\Dtos\BDServiceProviderDetailsType\CheckInOutTimesAType $checkInOutTimes = null, string $currencyCode = null, bool $bookable = null, string $planNumber = null, array $creditCards = null, \Conecto\FeratelDsi\Dtos\BDServiceProviderDetailsType\TownAType $town = null, string $district = null, string $code = null, string $type = null, int $priority = null, array $names = null, \Conecto\FeratelDsi\Dtos\MapPositionType $position = null, int $beds = null, \Conecto\FeratelDsi\Dtos\ItemType $stars = null, \Conecto\FeratelDsi\Dtos\ItemType $hotelChain = null, array $categories = null, array $classifications = null, array $marketingGroups = null, bool $active = null, string $gridSquare = null, string $dBCode = null, array $bankAccounts = null, string $dataOwner = null, string $licenceNumber = null, string $usage = null)
    {
        $this->name = $name;
        $this->names = $names;
        $this->town = $town;
