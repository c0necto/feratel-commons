...
/**
 * Class representing InfrastructureTypeType
 *
 *
 * XSD Type: InfrastructureTypeType
 */
class InfrastructureTypeType
{
    /**
     * @var int $type
     */
    ...
    public function __construct(int $type = null, int $order = null, \DateTime $changeDate = null, bool $active = null, array $name = null)
    {
        $this->type = $type;
        $this->order = $order;
