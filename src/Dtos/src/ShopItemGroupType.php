...
/**
 * Class representing ShopItemGroupType
 *
 *
 * XSD Type: ShopItemGroupType
 */
class ShopItemGroupType
{
    /**
     * @var string $id
     */
    ...
    public function __construct(string $id = null, string $type = null, int $order = null, \DateTime $changeDate = null, array $name = null)
    {
        $this->id = $id;
        $this->type = $type;
        $this->order = $order;
