...
class ServiceProviderPaymentAType
{
    ...
    /**
     * @var \Conecto\FeratelDsi\Dtos\ShoppingCartType\ContentAType\PaymentOptionsAType\CalculatedBasketResultAType\PaymentsAType\ServiceProviderPaymentAType\AmountPrePaymentAType $amountPrePayment
     */
    ...
    public function __construct(string $name = null, string $id = null, float $amountTotal = null, \Conecto\FeratelDsi\Dtos\ShoppingCartType\ContentAType\PaymentOptionsAType\CalculatedBasketResultAType\PaymentsAType\ServiceProviderPaymentAType\AmountPrePaymentAType $amountPrePayment = null, \DateTime $dueDatePrePayment = null, float $amountFinalPayment = null, \DateTime $dueDateFinalPayment = null)
    {
        $this->name = $name;
        $this->id = $id;
     ...
     *
     * @return \Conecto\FeratelDsi\Dtos\ShoppingCartType\ContentAType\PaymentOptionsAType\CalculatedBasketResultAType\PaymentsAType\ServiceProviderPaymentAType\AmountPrePaymentAType
     */
     ...
     *
     * @param \Conecto\FeratelDsi\Dtos\ShoppingCartType\ContentAType\PaymentOptionsAType\CalculatedBasketResultAType\PaymentsAType\ServiceProviderPaymentAType\AmountPrePaymentAType $amountPrePayment
     * @return self
     */
    public function setAmountPrePayment(\Conecto\FeratelDsi\Dtos\ShoppingCartType\ContentAType\PaymentOptionsAType\CalculatedBasketResultAType\PaymentsAType\ServiceProviderPaymentAType\AmountPrePaymentAType $amountPrePayment)
    {
        $this->amountPrePayment = $amountPrePayment;
        return $this;
    }
