...
/**
 * Class representing GetCancellationInformationAType
 */
class GetCancellationInformationAType
{
    /**
     * @var string $dBCode
     */
    ...
    public function __construct(string $dBCode = null, string $salesChannelId = null, string $serviceProviderId = null, string $productId = null, int $adults = null, string $children = null, \DateTime $from = null, \DateTime $to = null, int $duration = null, int $units = null)
    {
        $this->dBCode = $dBCode;
