...
{
    /**
     * @var \Conecto\FeratelDsi\Dtos\RequestType\ImportEventsAType\EventAType[] $event
     */
    private $event = [
     ...
     */
    public function addToEvent(\Conecto\FeratelDsi\Dtos\RequestType\ImportEventsAType\EventAType $event)
    {
        $this->event[] = $event;
        return $this;
    }
