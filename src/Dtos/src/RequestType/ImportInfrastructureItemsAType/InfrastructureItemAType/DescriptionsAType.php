...
{
    /**
     * @var \Conecto\FeratelDsi\Dtos\RequestType\ImportInfrastructureItemsAType\InfrastructureItemAType\DescriptionsAType\DescriptionAType[] $description
     */
    private $description = [
     ...
     */
    public function addToDescription(\Conecto\FeratelDsi\Dtos\RequestType\ImportInfrastructureItemsAType\InfrastructureItemAType\DescriptionsAType\DescriptionAType $description)
    {
        $this->description[] = $description;
        return $this;
    }
