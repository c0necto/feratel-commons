...
{
    /**
     * @var \Conecto\FeratelDsi\Dtos\RequestType\ImportInfrastructureItemsAType\InfrastructureItemAType\DetailsAType\ConnectedEntriesAType\ConnectedEntryAType[] $connectedEntry
     */
     ...
     */
    public function addToConnectedEntry(\Conecto\FeratelDsi\Dtos\RequestType\ImportInfrastructureItemsAType\InfrastructureItemAType\DetailsAType\ConnectedEntriesAType\ConnectedEntryAType $connectedEntry)
    {
        $this->connectedEntry[] = $connectedEntry;
        return $this;
    }
