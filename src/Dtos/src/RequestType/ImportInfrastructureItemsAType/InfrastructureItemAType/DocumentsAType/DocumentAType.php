...
class DocumentAType
{
    ...
    public function __construct(string $name = null, string $class = null, string $extension = null, int $size = null, string $type = null, string $copyright = null, int $order = null, int $showFrom = null, int $showTo = null, string $cCId = null, string $cCAuthor = null, string $cCCopyright = null, \DateTime $cCChangeDate = null, array $names = null, string $uRL = null)
    {
        $this->name = $name;
        $this->class = $class;
