...
{
    /**
     * @var \Conecto\FeratelDsi\Dtos\RequestType\ImportInfrastructureItemsAType\InfrastructureItemAType\LinksAType\LinkAType[] $link
     */
    private $link = [
     ...
     */
    public function addToLink(\Conecto\FeratelDsi\Dtos\RequestType\ImportInfrastructureItemsAType\InfrastructureItemAType\LinksAType\LinkAType $link)
    {
        $this->link[] = $link;
        return $this;
    }
