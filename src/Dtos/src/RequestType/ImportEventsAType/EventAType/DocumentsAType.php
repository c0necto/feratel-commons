...
{
    /**
     * @var \Conecto\FeratelDsi\Dtos\RequestType\ImportEventsAType\EventAType\DocumentsAType\DocumentAType[] $document
     */
    private $document = [
     ...
     */
    public function addToDocument(\Conecto\FeratelDsi\Dtos\RequestType\ImportEventsAType\EventAType\DocumentsAType\DocumentAType $document)
    {
        $this->document[] = $document;
        return $this;
    }
