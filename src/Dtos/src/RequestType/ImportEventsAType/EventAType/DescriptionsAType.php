...
{
    /**
     * @var \Conecto\FeratelDsi\Dtos\RequestType\ImportEventsAType\EventAType\DescriptionsAType\DescriptionAType[] $description
     */
    private $description = [
     ...
     */
    public function addToDescription(\Conecto\FeratelDsi\Dtos\RequestType\ImportEventsAType\EventAType\DescriptionsAType\DescriptionAType $description)
    {
        $this->description[] = $description;
        return $this;
    }
