...
class ResponseType
{
    ...
    public function __construct(int $index = null, array $addresses = null, \Conecto\FeratelDsi\Dtos\BookingType $booking = null, string $currencyCode = null, array $serviceProvider = null, \Conecto\FeratelDsi\Dtos\KeyValuesRSType $keyValues = null, array $serviceProviders = null, \Conecto\FeratelDsi\Dtos\ONAXBasicDataType $oNAXBasicData = null, array $serviceProviderData = null, \Conecto\FeratelDsi\Dtos\CalculatedOptionalFeesType $calculatedOptionalFees = null, \Conecto\FeratelDsi\Dtos\NLUpdatedAddressType $updatedAddress = null, array $changedServiceProviders = null, int $totalObjects = null, array $newslettersSent = null, array $package = null, array $newslettersUnsubscribed = null, array $checkEffectUsers = null, array $consentsUnsubscribed = null, \Conecto\FeratelDsi\Dtos\OrganisationInformationResultType $organisationInformation = null, array $cancellationInformation = null, \Conecto\FeratelDsi\Dtos\CanceledBookingType $canceledBooking = null, array $importEvents = null, \Conecto\FeratelDsi\Dtos\ShoppingCartStatusType $shoppingCartStatus = null, \Conecto\FeratelDsi\Dtos\SearchPackageCalculationResultType $packageCalculation = null, array $shopItems = null, array $events = null, array $deletedAddresses = null, array $packageContainers = null, array $packages = null, array $deletedItems = null, array $infrastructure = null, array $changedEvents = null, array $changedInfrastructures = null, array $calendarDates = null, array $insertedAddresses = null, \Conecto\FeratelDsi\Dtos\NLKeyValueDataType $keyValueData = null, \Conecto\FeratelDsi\Dtos\SearchPackageDetailsResultType $packageDetails = null, \Conecto\FeratelDsi\Dtos\GuestFullInfoType $guest = null, array $importedServiceProviders = null, array $newslettersSubscribed = null, \Conecto\FeratelDsi\Dtos\CheckEffectResultType $checkEffectData = null, array $consentsSubscribed = null, array $requests = null, array $availabilityCalendar = null, array $transactions = null, \Conecto\FeratelDsi\Dtos\PaymentInformationType $paymentInformation = null, \Conecto\FeratelDsi\Dtos\ShoppingCartType $shoppingCart = null, array $standardInformationForms = null, \Conecto\FeratelDsi\Dtos\ElectronicPaymentCheckOutTypeRSType $electronicPaymentCheckOut = null)
    {
        $this->index = $index;
