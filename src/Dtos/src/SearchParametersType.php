...
class SearchParametersType
{
    ...
    public function __construct(int $units = null, int $nights = null, array $accommodationHandicapFacility = null, array $classification = null, array $chain = null, array $category = null, array $accommodationFacility = null, float $minPrice = null, int $adults = null, int $index = null, string $salesChannel = null, \DateTime $from = null, \DateTime $to = null, string $multilineSearchCondition = null, bool $lastMinuteOnly = null, bool $splitOffersOnly = null, int $duration = null, array $preSelectedServiceProviderIDs = null, \Conecto\FeratelDsi\Dtos\SearchServiceProviderType $serviceProvider = null, string $children = null, string $meal = null, float $maxPrice = null, \Conecto\FeratelDsi\Dtos\BookOnlyType $bookOnly = null, array $serviceFacility = null, array $stars = null, \Conecto\FeratelDsi\Dtos\SearchParametersType\MarketingGroupAType $marketingGroup = null, \Conecto\FeratelDsi\Dtos\HotSpotSearchItemType $hotSpot = null, \Conecto\FeratelDsi\Dtos\SearchParametersType\PackageContainerAType $packageContainer = null, \Conecto\FeratelDsi\Dtos\SearchParametersType\TotalPriceFilterAType $totalPriceFilter = null)
    {
        $this->units = $units;
        $this->nights = $nights;
        $this->adults = $adults;
