...
/**
 * Class representing BDPackageProductPriceItemType
 *
 *
 * XSD Type: BDPackageProductPriceItem
 */
class BDPackageProductPriceItemType
{
    /**
    ...
    public function __construct(\DateTime $dateFrom = null, \DateTime $dateTo = null, string $categoryId = null, float $salesPrice = null, float $additionalNight = null, int $duration = null, array $priceValue = null)
    {
