...
/**
 * Class representing STUAddressesResponseListType
 *
 *
 * XSD Type: STUAddressesResponseList
 */
class STUAddressesResponseListType
{
    /**
     * @var \Conecto\FeratelDsi\Dtos\STUAddressResponseType[] $address
     */
    private $address = [
     ...
     */
    public function addToAddress(\Conecto\FeratelDsi\Dtos\STUAddressResponseType $address)
    {
        $this->address[] = $address;
        return $this;
    }
