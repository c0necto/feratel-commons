...
class BDEventItemType
{
    ...
    public function __construct(string $id = null, \DateTime $changeDate = null, string $systems = null, string $systemId = null, string $cCId = null, string $cCAuthor = null, string $cCCopyright = null, \DateTime $cCChangeDate = null, \Conecto\FeratelDsi\Dtos\BDEventDetailsType $details = null, array $addresses = null, array $descriptions = null, array $documents = null, array $links = null, \Conecto\FeratelDsi\Dtos\FacilityItemListType $facilities = null, \Conecto\FeratelDsi\Dtos\CustomAttributeListType $customAttributes = null, \Conecto\FeratelDsi\Dtos\HandicapFacilitiesItemListType $handicapFacilities = null, \Conecto\FeratelDsi\Dtos\BDHandicapClassificationsType $handicapClassifications = null, \Conecto\FeratelDsi\Dtos\BDInfrastructureQualityDetailsType $qualityDetails = null, array $annotations = null, array $guestCards = null)
    {
        $this->id = $id;
