...
{
    /**
     * @var \Conecto\FeratelDsi\Dtos\BDEventDetailsType\ConnectedEntriesAType\ConnectedEntryAType[] $connectedEntry
     */
     ...
     */
    public function addToConnectedEntry(\Conecto\FeratelDsi\Dtos\BDEventDetailsType\ConnectedEntriesAType\ConnectedEntryAType $connectedEntry)
    {
        $this->connectedEntry[] = $connectedEntry;
        return $this;
    }
