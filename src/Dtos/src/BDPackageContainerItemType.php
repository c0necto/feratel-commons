...
/**
 * Class representing BDPackageContainerItemType
 *
 *
 * XSD Type: BDPackageContainerItem
 */
class BDPackageContainerItemType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var \Conecto\FeratelDsi\Dtos\BDPackageContainerDetailsType $details
     */
    ...
    /**
     * @var \Conecto\FeratelDsi\Dtos\BDPackageAssignedProductItemType[] $assignedProducts
     */
    private $assignedProducts = null;

    public function __construct(string $id = null, \DateTime $changeDate = null, \Conecto\FeratelDsi\Dtos\BDPackageContainerDetailsType $details = null, array $descriptions = null, array $documents = null, array $links = null, array $assignedProducts = null)
    {
        $this->id = $id;
     ...
     * Gets as details
     *
     * @return \Conecto\FeratelDsi\Dtos\BDPackageContainerDetailsType
     */
     ...
     * Sets a new details
     *
     * @param \Conecto\FeratelDsi\Dtos\BDPackageContainerDetailsType $details
     * @return self
     */
    public function setDetails(?\Conecto\FeratelDsi\Dtos\BDPackageContainerDetailsType $details = null)
    {
        $this->details = $details;
        return $this;
    }
     ...
     */
    public function addToAssignedProducts(\Conecto\FeratelDsi\Dtos\BDPackageAssignedProductItemType $assignedProduct)
    {
     ...
     *
     * @param \Conecto\FeratelDsi\Dtos\BDPackageAssignedProductItemType[] $assignedProducts
     * @return self
     */
