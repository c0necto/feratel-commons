...
/**
 * Class representing BDPackageContainerDetailsType
 *
 *
 * XSD Type: BDPackageContainerDetailsType
 */
class BDPackageContainerDetailsType
{
    /**
    ...
    public function __construct(array $name = null, int $priority = null, array $meetingPoint = null, array $holidayThemes = null, bool $active = null, string $dBCode = null, \Conecto\FeratelDsi\Dtos\MapPositionType $position = null, \Conecto\FeratelDsi\Dtos\BDProductValidDatesType $validDates = null, array $packageCategories = null, string $owner = null)
    {
        $this->name = $name;
