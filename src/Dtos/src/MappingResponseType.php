...
/**
 * Class representing MappingResponseType
 *
 *
 * XSD Type: MappingResponseType
 */
class MappingResponseType
{
    /**
     * @var \Conecto\FeratelDsi\Dtos\MappingResponseType\ServiceProviderAType[] $serviceProvider
     */
     ...
     */
    public function addToServiceProvider(\Conecto\FeratelDsi\Dtos\MappingResponseType\ServiceProviderAType $serviceProvider)
    {
        $this->serviceProvider[] = $serviceProvider;
        return $this;
    }
