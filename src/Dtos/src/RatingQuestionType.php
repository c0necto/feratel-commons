...
/**
 * Class representing RatingQuestionType
 *
 *
 * XSD Type: RatingQuestionType
 */
class RatingQuestionType
{
    /**
     * @var string $id
     */
    ...
    public function __construct(string $id = null, bool $active = null, string $type = null, int $order = null, array $name = null)
    {
        $this->id = $id;
        $this->active = $active;
        $this->type = $type;
